...
public class POJOpracticeWithSpartanApp {
   ...
   public void addSpartan() {
       ...
       spartan.put("name", "Enes Kanter");
       spartan.put("phone", "1236547814");


       // we can this below also
       RequestSpecification requestSpecification = given().
               auth().basic("admin", "admin").  // we can this below also
       ...
       Spartan spartan1 = response.jsonPath().getObject("data", Spartan.class);
       System.out.println(spartan1 instanceof Spartan);
   }
...
//contentType---> is like export, we use contentType(JSON) - to specify Type of content that we are sending To the server
    ...
    public void patchUserTest1(){
        ...
        update.put("name", "OyyyyDarlandum");
        ...
        given().
                ...
                then().
                assertThat().statusCode(200).body("name", is("OyyyyDarlandum"));
    }
